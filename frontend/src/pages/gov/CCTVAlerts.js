...
const CCTVAlerts = () => {
  ...
  const fetchIncidents = async () => {
    try {
      ...
      toast.error('Failed to load CCTV alerts');
    }
  };
      ...
      <div className="p-6 space-y-6" data-testid="cctv-alerts-page">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-[#1E293B] border border-[#334155] rounded-lg p-4">
            <p className="text-[#94A3B8] text-sm uppercase">Total CCTV</p>
        ...
        <div className="space-y-4">
          {loading ? (
            <div className="text-center py-12">
              <p className="text-[#94A3B8]">Loading CCTV alerts...</p>
            </div>
          ) : incidents.length === 0 ? (
            <div className="bg-[#1E293B] border border-[#334155] rounded-lg p-12 text-center">
              <Camera className="w-12 h-12 mx-auto mb-3 text-[#94A3B8] opacity-50" />
              <p className="text-[#94A3B8]">No CCTV alerts at this time</p>
            </div>
          ) : (
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="text-[#94A3B8]">Camera Location</p>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="text-[#94A3B8]">Detected At</p>
                      ...
                      <div className="flex items-start gap-2">
                        <Camera className="w-4 h-4 text-[#94A3B8] mt-0.5" />
                        <div>
                          <p className="text-[#94A3B8]">Detection System</p>
                          <p className="text-white font-medium">{incident.reportedBy || 'AI_CCTV_SYSTEM'}</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Camera className="w-4 h-4 text-[#94A3B8] mt-0.5" />
